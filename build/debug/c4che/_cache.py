...
CFLAGS_PYEMBED = ['-g', '-fwrapv', '-O2', '-g', '-fwrapv', '-O2', '-g', '-ffile-prefix-map=/build/python3.9-RNBry6/python3.9-3.9.2=.', '-fstack-protector-strong', '-g', '-fwrapv', '-O2', '-fno-strict-aliasing']
CFLAGS_PYEXT = ['-g', '-fwrapv', '-O2', '-pthread', '-g', '-fwrapv', '-O2', '-g', '-fwrapv', '-O2', '-g', '-ffile-prefix-map=/build/python3.9-RNBry6/python3.9-3.9.2=.', '-fstack-protector-strong', '-g', '-fwrapv', '-O2', '-fno-strict-aliasing']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-g', '-fwrapv', '-O2', '-g', '-fwrapv', '-O2', '-g', '-ffile-prefix-map=/build/python3.9-RNBry6/python3.9-3.9.2=.', '-fstack-protector-strong', '-g', '-fwrapv', '-O2', '-fno-strict-aliasing']
CXXFLAGS_PYEXT = ['-g', '-fwrapv', '-O2', '-pthread', '-g', '-fwrapv', '-O2', '-g', '-fwrapv', '-O2', '-g', '-ffile-prefix-map=/build/python3.9-RNBry6/python3.9-3.9.2=.', '-fstack-protector-strong', '-g', '-fwrapv', '-O2', '-fno-strict-aliasing']
...
EXAMPLE_DIRECTORIES = ['error-model', 'tutorial', 'udp-client-server', 'matrix-topology', 'channel-models', 'energy', 'routing', 'socket', 'ipv6', 'realtime', 'tcp', 'wireless', 'naming', 'traffic-control', 'stats', 'udp']
...
NS3_EXECUTABLE_PATH = ['/root/projects/ns-allinone-3.35/ns-3.35/build/debug/src/fd-net-device', '/root/projects/ns-allinone-3.35/ns-3.35/build/debug/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/10', '/root/projects/ns-allinone-3.35/ns-3.35/build/debug/lib', '/root/projects/ns-allinone-3.35/ns-3.35/build/debug']
...
cfg_files = ['/root/projects/ns-allinone-3.35/ns-3.35/build/debug/ns3/config-store-config.h', '/root/projects/ns-allinone-3.35/ns-3.35/build/debug/ns3/core-config.h']
cprogram_PATTERN = '%s'
